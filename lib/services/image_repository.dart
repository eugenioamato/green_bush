...
class ImageRepository {
  ...
  Uint8List getBlob(int page) => (_src.containsKey(page) &&
          _src[page] != null &&
          _src[page]!.blob.isNotEmpty)
      ? (_src[page]!.blob)
      : Uint8List(0);
  void setBlob(int page, Uint8List data) =>
      (_src.containsKey(page) && _src[page] != null)
          ? _src[page]!.updateBlob(data)
          : null;
